                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                              ...
                              $item1 = ["image"=>"samsung-galaxy-s9-xxl.jpg", "name"=>"Samsung Galaxy S9",
                                        "price"=>"15000"];
                              $item2 = ["image"=>"l6g6.jpg", "name"=>"LG G6",
                                        "price"=>"10000"];
                              $item3 = ["image"=>"Screen Shot 2017-11-01 at 13.01.54.png", "name"=>"iPhone 8",
                                        "price"=>"16000"];
                              $item4 = ["image"=>"motorola-moto-g5-plus-1.jpg", "name"=>"Motorola G5",
                                        "price"=>"9000"];
                              $item5 = ["image"=>"motorola-moto-g4-3.jpg", "name"=>"Motorola G5",
                                        "price"=>"8000"];
                              $item6 = ["image"=>"003.jpg", "name"=>"Motorola G5",
                                        "price"=>"10000"];
                              ...
                              foreach ($items as $key => $value) {
                                //echo "key: ".$key."- value: ".$value["image"];
                                ...
                                $item->id = "1234";
                                $item->external_reference = "octavio@digitum.com.mx";
                                $item->description = "Dispositivo móvil de Tienda e-commerce";
                                $item->quantity = 1;
                                $item->back_urls->sucess = "https://octavio64-mp-commerce-php.herokuapp.com/sucess.php";
                                $item->back_urls->pending = "https://octavio64-mp-commerce-php.herokuapp.com/pending.php";
                                $item->back_urls->failure = "https://octavio64-mp-commerce-php.herokuapp.com/failure.php";
                              ...
                              <div class="as-producttile large-4 small-6 group-1">
                                  <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                                      <div class="as-dummy-container as-dummy-img">
                                          <img src="./assets/<?php echo $value['image']; ?>" class="ir ir item-image as-producttile-image  " alt="" width="445" height="445">
                                      </div>
                                      <div class="images mini-gallery gal1 ">
                                          <ul class="clearfix as-producttile-nojs">
                                              <li class="as-searchtile-nojs">
                                                  <img src="./assets/<?php echo $value['image']; ?>" class="ir relatedlink item-image as-producttile-image" alt="" width="445" height="445" data-scale-params-2="wid=890&amp;hei=890&amp;fmt=jpeg&amp;qlt=95&amp;op_usm=0.5,0.5&amp;.v=1502831144597">
                                              </li>
                                          </ul>
                                          ...
                                          <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                              <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="2|Beats Studio3 Wireless Over‑Ear Headphones - Shadow Gray|MQUF2">
                                                  <div class="as-tilegallery-element as-image-selected">
                                                      <div class=""></div>
                                                      <img src="./assets/<?php echo $value['image']; ?>" class="ir ir item-image as-producttile-image" alt="" data-desc="Samsung galaxy" style="content:-webkit-image-set(url(https://md6.pricebaba.com/images/product/mobile/46638/samsung-galaxy-s9-xxl.jpg">
                                                  </div>
                                  ...
                                  <div class="as-producttile-info" style="min-height: 168px;">
                                          ...
                                          <div class="as-producttile-title">
                                              <h3 class="as-producttile-name">
                                                  <p class="as-producttile-tilelink">
                                                      <span data-ase-truncate="2"><?php echo $value['name']; ?></span>
                                                  </p>
                                      ...
                                      <form class="pay" action="/payment.php" method="get">
                                        <script
                                         src="https://www.mercadopago.com.mx/integrations/v1/web-payment-checkout.js"
                                         data-preference-id="<?php echo $preference->id; ?>">
                                        </script>
                                          <input type="hidden" name="img" value="./assets/<?php echo $value['image']; ?>">
